...
class main_list_adapter1(items: ArrayList<item1>) : RecyclerView.Adapter<main_list_adapter1.itemViewHolder>() {
    lateinit var context:Context
    var mitems: java.util.ArrayList<item1>?
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): main_list_adapter1.itemViewHolder {
    ...
    override fun onBindViewHolder(holder: main_list_adapter1.itemViewHolder, position: Int) {
        var current_item_position:item1 = mitems!!.get(position)
        ...
        holder.itemView.setOnClickListener(View.OnClickListener {
            ...
            i.putExtra("position2","recycler1")
