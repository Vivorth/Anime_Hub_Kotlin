...
class main_list_adapter(items: ArrayList<item>) : RecyclerView.Adapter<main_list_adapter.itemViewHolder>() {
    lateinit var context:Context
    var mitems: java.util.ArrayList<item>?
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): main_list_adapter.itemViewHolder {
...
init {
 ...
 class itemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
    ...
    override fun onBindViewHolder(holder: main_list_adapter.itemViewHolder, position: Int) {
        var current_item_position:item = mitems!!.get(position)
